  ...
  return (
    ...
    >
      <Card className="glass border-white/10 h-full flex flex-col overflow-hidden">
        ...
        {/* IMPORTANT: CardContent must be a flex column with flex-1 and min-h-0 */}
        <CardContent className="p-0 flex flex-col flex-1 min-h-0">
          {/* Height owner */}
          <div className="flex-1 flex flex-col min-h-0">
            {/* SCROLL AREA — has flex-1, min-h-0, overflow-y-auto */}
            <div className="flex-1 min-h-0 overflow-y-auto pr-2 chat-scroll scrollbar-thin">
            ...
            {/* Footer: typing + input (fixed at bottom) */}
